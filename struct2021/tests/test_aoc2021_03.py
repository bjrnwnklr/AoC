...
from solutions.aoc2021_03 import load_input, part1, part2


class Test_AOC2021_03:
    ...
    def test_1_1(self):
        puzzle_input = load_input('testinput/03_1_1.txt')
        assert part1(puzzle_input) == 198

    def test_2_1(self):
        puzzle_input = load_input('testinput/03_1_1.txt')
        assert part2(puzzle_input) == 230
