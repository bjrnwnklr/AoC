...
from solutions.aoc2021_02 import load_input, part1, part2


class Test_AOC2021_02:
    ...
    def test_1_1(self):
        puzzle_input = load_input('testinput/02_1_1.txt')
        assert part1(puzzle_input) == 150

    def test_2_1(self):
        puzzle_input = load_input('testinput/02_1_1.txt')
        assert part2(puzzle_input) == 900
