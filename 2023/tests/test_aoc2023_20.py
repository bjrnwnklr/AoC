...
from solutions.aoc2023_20 import load_input, part1, part2


class Test_AOC2023_20:
    ...
    def test_1_1(self):
        ...
        assert part1(puzzle_input) == 32000000

    def test_1_2(self):
        puzzle_input = load_input("testinput/20_1_2.txt")
