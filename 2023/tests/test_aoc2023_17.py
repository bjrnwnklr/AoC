...
from solutions.aoc2023_17 import load_input, part1, part2


class Test_AOC2023_17:
    ...
    def test_1_1(self):
        ...
        assert part1(puzzle_input) == 102

    def test_2_1(self):
        puzzle_input = load_input("testinput/17_1_1.txt")
        assert part2(puzzle_input) == 94

    def test_2_2(self):
        puzzle_input = load_input("testinput/17_2_1.txt")
        assert part2(puzzle_input) == 71
