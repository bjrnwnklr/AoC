...
from solutions.aoc2021_06 import load_input, part1, part2


class Test_AOC2021_06:
    ...
    def test_1_1(self):
        ...
        assert part1(puzzle_input) == 5934

    def test_2_1(self):
        puzzle_input = load_input('testinput/06_1_1.txt')
        assert part2(puzzle_input) == 26984457539
        # assert part2(puzzle_input) == 5934
