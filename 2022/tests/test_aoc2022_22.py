...
class Test_AOC2022_22:
    ...
    def test_2_1_wrap_4_2(self):
        ...
        assert new_pos.row == 49
        assert new_pos.col == 50
        pos = Position(110, 0, 2)
        assert which_side(pos) == 4
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 0
        assert new_pos.row == 39
        assert new_pos.col == 50

    def test_2_1_wrap_5_0(self):
        raw_map, instructions = load_input("input/22.txt")
        grid = parse_map(raw_map)
        pos = Position(100, 99, 0)
        assert which_side(pos) == 5
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 2
        assert new_pos.row == 49
        assert new_pos.col == 149
        pos = Position(110, 99, 0)
        assert which_side(pos) == 5
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 2
        assert new_pos.row == 39
    ...
    def test_2_1_wrap_5_1(self):
        raw_map, instructions = load_input("input/22.txt")
        grid = parse_map(raw_map)
        pos = Position(149, 50, 1)
        assert which_side(pos) == 5
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 2
        assert new_pos.row == 150
        assert new_pos.col == 49
        pos = Position(149, 60, 1)
        assert which_side(pos) == 5
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 2
        assert new_pos.row == 160
        assert new_pos.col == 49

    def test_2_1_wrap_6_2(self):
        raw_map, instructions = load_input("input/22.txt")
        grid = parse_map(raw_map)
        pos = Position(150, 0, 2)
        assert which_side(pos) == 6
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 1
        assert new_pos.row == 0
        assert new_pos.col == 50
        pos = Position(160, 0, 2)
        assert which_side(pos) == 6
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 1
        assert new_pos.row == 0
    ...
    def test_2_1_wrap_6_0(self):
        raw_map, instructions = load_input("input/22.txt")
        grid = parse_map(raw_map)
        pos = Position(150, 49, 0)
        assert which_side(pos) == 6
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 3
        assert new_pos.row == 149
        assert new_pos.col == 50
        pos = Position(160, 49, 0)
        assert which_side(pos) == 6
        new_pos = wrap_cube(pos, grid)
        assert new_pos.facing == 3
        assert new_pos.row == 149
