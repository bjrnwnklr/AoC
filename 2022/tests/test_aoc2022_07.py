...
from solutions.aoc2022_07 import load_input, part1, part2


class Test_AOC2022_07:
    ...
    def test_1_1(self):
        puzzle_input = load_input("testinput/07_1_1.txt")
        assert part1(puzzle_input) == 95437

    def test_2_1(self):
        puzzle_input = load_input("testinput/07_1_1.txt")
        assert part2(puzzle_input) == 24933642
