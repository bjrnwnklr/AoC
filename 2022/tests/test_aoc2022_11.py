...
from solutions.aoc2022_11 import load_input, part1, part2


class Test_AOC2022_11:
    ...
    def test_1_1(self):
        puzzle_input = load_input("testinput/11_1_1.txt")
        assert part1(puzzle_input) == 10605

    def test_2_1(self):
        puzzle_input = load_input("testinput/11_1_1.txt")
        assert part2(puzzle_input) == 2713310158

    # def test_2_2(self):
    #     puzzle_input = load_input("testinput/11_2_1.txt")
