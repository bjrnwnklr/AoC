...
##### define registers ######
# part 2:
# the code finds prime factors for the number in register #1 (10551398)
# then adds the prime factors (including 1 and 10551398 itself) in reg #0
