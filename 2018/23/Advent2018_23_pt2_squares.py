...
# not needed, i have my own bot parsing
def get_bots(values):
...
# not needed, calculates part 1 (finds bot with biggest radius, then how many bots intersect with it)
# Note: could have been done with list comprehensions...
def calc(values):
...
# this is the magic function for part 2!
...
# wrapper function for part 2, calls 'find'
def calc2(values):
    bots = get_bots(values)
