...
from solutions.aoc2024_05 import load_input, part1, part2


class Test_AOC2024_5:
    ...
    def test_1_1(self):
        rules, printing = load_input("testinput/05_1_1.txt")
        assert part1(rules, printing) == 143

    def test_2_1(self):
        rules, printing = load_input("testinput/05_1_1.txt")
        assert part2(rules, printing) == 123
